/**
 * UI Templates barrel export
 */

export { getCategoryFormHTML, CATEGORY_FORM_SIZE } from './categoryForm'
export type { CategoryFormOptions } from './categoryForm'

export { getDeleteConfirmHTML, DELETE_CONFIRM_SIZE } from './deleteConfirm'
...
export { getSettingsHTML, SETTINGS_SIZE } from './settings'
